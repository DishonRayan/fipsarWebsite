...
const ResultsSection: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full relative flex flex-col items-center py-16 px-4 sm:px-6 lg:px-8 font-sans overflow-x-hidden" style={{ backgroundColor: BRAND_COLOR }}>
      {/* Background Textures */}
