...
const IndustrySection: React.FC = () => {
  ...
  return (
    <section 
      ...
      className=" relative w-full overflow-hidden bg-white transition-colors duration-700 pt-0"
    >
      <style>
        {`
          @keyframes marquee {
      ...
      <div className="container mx-auto px-6 relative z-20 pt-32 md:pt-44">
        {/* Main Headline - Compact and strictly 3 lines */}
        <div className={`max-w-4xl mx-auto text-center mb-16 entrance-anim ${isVisible ? 'visible' : ''}`}>
